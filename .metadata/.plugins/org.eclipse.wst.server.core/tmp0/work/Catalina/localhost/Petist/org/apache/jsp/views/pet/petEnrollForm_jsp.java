 ...
 * Generated at: 2022-09-02 13:40:17 UTC
...
public final class petEnrollForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Petist-반려동물 등록</title>\r\n");
 ...
 if(loginUser.getMemberId().equals("admin")) { 
      ...
      out.write("			<div id=\"petMain\">등록 절차</div>\r\n");
      out.write("		</div>\r\n");
      out.write("		<div class=\"content_2\" >\r\n");
      out.write("			<div class=\"outer\">\r\n");
      out.write("				<form id=\"enroll-form\" enctype=\"multipart/form-data\" action=\"");
      out.print( contextPath );
      out.write("/insert.pe\" method=\"post\">\r\n");
      out.write("					\r\n");
      out.write("					<table id=\"petenroll\">\r\n");
      out.write("						<thead>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td>* 는 반드시 입력해주세요.</td>\r\n");
      out.write("							</tr>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td><input type=\"hidden\" name=\"petOwner\" value=\"");
      ...
      out.write("						<tbody>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td>* 반려동물 사진을 올려주세요.</td>\r\n");
      out.write("								<td><img id=\"titleImg\" src=\"https://img.freepik.com/free-vector/touch-icon-hand-symbol-finger-touching-screen_543062-137.jpg?w=740\"></td>\r\n");
      out.write("								<td></td>\r\n");
      out.write("							</tr>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td>* 반려동물 종류을 골라주세요.</td>\r\n");
      out.write("								<td>\r\n");
      out.write("								<select class=\"values\" name=\"petKind\">\r\n");
      out.write("									<option value=\"강아지\">강아지</option>\r\n");
      out.write("									<option value=\"고양이\">고양이</option>\r\n");
      out.write("									<option value=\"새\">새</option>\r\n");
      out.write("									<option value=\"물고기\">물고기</option>\r\n");
      ...
      out.write("						\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td>* 마이펫 이름 : </td>\r\n");
      out.write("								<td><input class=\"values\" type=\"text\" name=\"petName\" maxlength=\"20\" placeholder=\"펫 이름을 입력해주세요.\" required></td>\r\n");
      out.write("							</tr>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td>&nbsp;&nbsp;등록번호 : </td>\r\n");
      out.write("								<td><input class=\"values\" type=\"text\" name=\"petInputNo\" oninput=\"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\\..*)\\./g, '$1');\" maxlength=\"20\" placeholder=\"인식표 등록 번호\"> </td>\r\n");
      out.write("							</tr>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td>* 품종 : </td>\r\n");
      out.write("								<td><input class=\"values\" type=\"text\" name=\"petBreed\" maxlength=\"50\" placeholder=\"품종을 입력해주세요\" required></td>\r\n");
      out.write("							</tr>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td>* 생일 : </td>\r\n");
      out.write("								<td><input class=\"values\" type=\"date\" name=\"petBirth\"required></td>\r\n");
      out.write("							</tr>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td>* 중성화 : </td>\r\n");
      out.write("								<td><input class=\"values\" type=\"text\" name=\"petNeutral\" maxlength=\"1\" placeholder=\"Y / N\" onkeyup=\"neutralCheck();\" required></td>\r\n");
      out.write("							</tr>\r\n");
      out.write("							<tr>\r\n");
      out.write("							<td>\r\n");
      out.write("								<div class=\"check checkFalse\" id=\"neutralFalse\" style=\"display:none;\">Y,N 만 입력해주세요.</div>\r\n");
      out.write("							</td>\r\n");
      out.write("						</tr>	\r\n");
      out.write("						</tbody>\r\n");
      out.write("						\r\n");
      ...
      out.write("							<input type=\"file\" name=\"file\" id=\"file\" required onchange=\"loadImg(this);\"> <!-- 대표 이미지 : 필수 입력 -->\r\n");
      out.write("					</div>\r\n");
      out.write("					<script>\r\n");
      out.write("		\r\n");
      out.write("						$(function(){\r\n");
      ...
      out.write("							}\r\n");
      out.write("							else{\r\n");
      out.write("								$(\"#titleImg\").attr(\"src\", \"https://cnucc.jbnu.ac.kr/korean/system/concert/image/noimage02.gif\");\r\n");
      out.write("										\r\n");
      out.write("							}\r\n");
      out.write("						}\r\n");
      out.write("						\r\n");
      out.write("						function neutralCheck(){\r\n");
      out.write("							var $petNeutral = $(\"#enroll-form input[name=petNeutral]\");\r\n");
      out.write("							var regExp = /^[NY]$/;\r\n");
      out.write("							if(!regExp.test($petNeutral.val())){ \r\n");
      out.write("								$(\"#neutralFalse\").attr('style',\"display:block\");\r\n");
      out.write("							} else { \r\n");
      out.write("								$(\"#neutralFalse\").attr('style',\"display:none\");\r\n");
      out.write("								var ok3 = \"Y\";\r\n");
      out.write("								return ok3;\r\n");
      out.write("							}\r\n");
      out.write("							if($petNeutral.val() == \"\"){\r\n");
      out.write("								$(\"#neutralFalse\").attr('style',\"display:none\");\r\n");
      out.write("							}\r\n");
      out.write("					    }\r\n");
      out.write("					</script>\r\n");
      ...
      out.write("						<button type=\"submit\" class=\"btn btn-sm btn-info\">작성하기</button>\r\n");
      out.write("						<button type=\"reset\" class=\"btn btn-sm btn-danger\">되돌리기</button>\r\n");
